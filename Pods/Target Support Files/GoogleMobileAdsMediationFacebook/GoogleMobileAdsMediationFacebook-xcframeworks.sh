...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationFacebook/FacebookAdapter-6.5.1.0/FacebookAdapter.xcframework" "GoogleMobileAdsMediationFacebook" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
